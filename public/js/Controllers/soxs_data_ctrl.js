...
angular.module('soxsnationApp')
    .controller('SoxsDataLayoutController', ['$scope', '$location', 'soxsAuth', 'soxsItemFactory', 'Drag_Factory',
        function($scope, $location, soxsAuth, soxsItemFactory, Drag_Factory) {
            ...
            $scope.created_layout = '<div>No Layout</div>';
            $scope.drops = 0;
            ...
            $scope.layout_dropped = function(layout) {
                // console.log('SoxsDataLayoutController::layout_dropped: ' + Drag_Factory.valid_drop);
                if (Drag_Factory.valid_drop && Drag_Factory.drop_accepted) {
                $scope.created_layout = layout;
                $scope.drops = $scope.drops + 1;
            }
            }
            ...
            var update_layout = function(layout) {
            	console.log('SoxsDataLayoutController::update_layout: ' + Drag_Factory.valid_drop);
                if (Drag_Factory.valid_drop) {
                    $scope.created_layout = layout;
                    console.log('SoxsDataLayoutController::Drag_Factory.layout: ' + JSON.stringify(layout));
